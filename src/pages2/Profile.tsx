    ...
    <MobileLayout>
      <div className="page-container">
        ...
        <div className="p-2 flex flex-col">
          <div className="text-2xl font-bold text-orange-500 animate-float mb-2">{communityStats.totalProjects}</div>
          <div className="text-xs text-muted-foreground">Projects</div>
        </div>
        <div className="p-2 border-x border-border flex flex-col">
          <div className="text-2xl font-bold text-orange-500 animate-float mb-2">{communityStats.totalPoints}</div>
          <div className="text-xs text-muted-foreground">Points</div>
        </div>
        <div className="p-2 flex flex-col">
          <div className="mt-2 text-md font-bold text-orange-500 animate-float mb-2">{communityStats.totalImpact}</div>
